<?php
    class Modelo_UnidadMedida{
        ...
        function Modificar_UnidadMedida($id ,$unidadactual,$unidadnueva ,$abreviaturaeditar, $estatus){
            $sql = "call SP_EDITAR_UNIDADMEDIDA('$id' ,'$unidadactual','$unidadnueva' ,'$abreviaturaeditar', '$estatus')";
